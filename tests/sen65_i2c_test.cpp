...
TEST_GROUP (SEN65_Tests) {
    void setup() {
        sen65_init(0x6B);
    }
};

TEST (SEN65_Tests, test_get_product_name1) {
    int16_t local_error = 0;
    int8_t product_name[32] = {0};
    local_error = sen65_get_product_name(product_name, 32);
    CHECK_EQUAL_ZERO_TEXT(local_error, "get_product_name");
    printf("product_name: %s\n", product_name);
}

TEST (SEN65_Tests, test_get_serial_number1) {
    int16_t local_error = 0;
    int8_t serial_number[32] = {0};
    local_error = sen65_get_serial_number(serial_number, 32);
    CHECK_EQUAL_ZERO_TEXT(local_error, "get_serial_number");
    printf("serial_number: %s\n", serial_number);
}

TEST (SEN65_Tests, test_device_reset1) {
    int16_t local_error = 0;
    local_error = sen65_device_reset();
    CHECK_EQUAL_ZERO_TEXT(local_error, "device_reset");
}

TEST (SEN65_Tests, test_start_fan_cleaning1) {
    int16_t local_error = 0;
    local_error = sen65_start_fan_cleaning();
    CHECK_EQUAL_ZERO_TEXT(local_error, "start_fan_cleaning");
}

TEST (SEN65_Tests, test_set_temperature_offset_parameters1) {
    int16_t local_error = 0;
...
TEST (SEN65_Tests, test_set_voc_algorithm_tuning_parameters1) {
    int16_t local_error = 0;
    local_error =
        sen65_set_voc_algorithm_tuning_parameters(100, 12, 12, 180, 50, 230);
    CHECK_EQUAL_ZERO_TEXT(local_error, "set_voc_algorithm_tuning_parameters");
}

TEST (SEN65_Tests, test_get_voc_algorithm_tuning_parameters1) {
    int16_t local_error = 0;
    ...
    local_error = sen65_get_voc_algorithm_tuning_parameters(
...
TEST (SEN65_Tests, test_set_nox_algorithm_tuning_parameters1) {
    int16_t local_error = 0;
    local_error =
        sen65_set_nox_algorithm_tuning_parameters(1, 12, 12, 720, 50, 230);
    CHECK_EQUAL_ZERO_TEXT(local_error, "set_nox_algorithm_tuning_parameters");
}

TEST (SEN65_Tests, test_get_nox_algorithm_tuning_parameters1) {
    int16_t local_error = 0;
    int16_t index_offset = 0;
    int16_t learning_time_offset_hours = 0;
    int16_t learning_time_gain_hours = 0;
    ...
    int16_t std_initial = 0;
    int16_t gain_factor = 0;
    local_error = sen65_get_nox_algorithm_tuning_parameters(
        &index_offset, &learning_time_offset_hours, &learning_time_gain_hours,
        &gating_max_duration_minutes, &std_initial, &gain_factor);
...
TEST (SEN65_Tests, test_set_temperature_acceleration_parameters1) {
    int16_t local_error = 0;
...
TEST (SEN65_Tests, test_get_voc_algorithm_state1) {
    int16_t local_error = 0;
    uint8_t state[8] = {0};
    local_error = sen65_get_voc_algorithm_state(state, 8);
...
TEST (SEN65_Tests, test_activate_sht_heater1) {
    int16_t local_error = 0;
    local_error = sen65_activate_sht_heater();
    CHECK_EQUAL_ZERO_TEXT(local_error, "activate_sht_heater");
}

TEST (SEN65_Tests, test_read_device_status1) {
    int16_t local_error = 0;
    sen65_device_status device_status = {.value = 0u};
    local_error = sen65_read_device_status(&device_status);
    CHECK_EQUAL_ZERO_TEXT(local_error, "read_device_status");
    printf("device_status: %02x\n", device_status.value);
}

TEST (SEN65_Tests, test_read_and_clear_device_status1) {
    int16_t local_error = 0;
    sen65_device_status device_status = {.value = 0u};
    local_error = sen65_read_and_clear_device_status(&device_status);
    CHECK_EQUAL_ZERO_TEXT(local_error, "read_and_clear_device_status");
    printf("device_status: %02x\n", device_status.value);
}

TEST (SEN65_Tests, test_start_continuous_measurement1) {
    int16_t local_error = 0;
    uint8_t padding = 0;
    ...
    uint16_t raw_nox = 0;
    uint8_t state[8] = {0};
    local_error = sen65_start_continuous_measurement();
    CHECK_EQUAL_ZERO_TEXT(local_error, "start_continuous_measurement");
    local_error = sen65_get_data_ready(&padding, &data_ready);
    ...
    local_error = sen65_read_measured_raw_values(
    ...
    print_byte_array(state, 8);
    printf("\n");
    local_error = sen65_stop_measurement();
