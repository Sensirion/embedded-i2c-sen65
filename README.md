# Sensirion I2C SEN65 embedded Library

This document explains how to set up a SEN65 sensor to run on an embedded device using the I²C interface.
...
Use the following description to connect your SEN65:
...
5. Run the compiled executable with `./sen65_i2c_example_usage`
...
5. Run the compiled executable with `./sen65_test_hw_i2c`.
